...
function isPermitted(name, version) {
  var targetWhitelist = assign({}, MODULES_WHITELIST, userWhitelist);
  var target;
  ...
  if (Object.keys(targetWhitelist).indexOf(name) !== -1) {
    target = targetWhitelist[name];
...
function whitelist(modules) {
  Object.keys(modules).forEach(function iterateOverModule(name) {
